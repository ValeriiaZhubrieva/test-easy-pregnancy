import "./main.min.js";
import { n as slideToggle, r as slideUp, t as dataMediaQueries } from "./common.min.js";
...
function initSliders() {
	if (document.querySelector(".results__slider")) new Swiper(".results__slider", {
		...
		navigation: {
			prevEl: ".results__nav .swiper-button-prev",
			nextEl: ".results__nav .swiper-button-next"
		},
		on: {}
	});
}
